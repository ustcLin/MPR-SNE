...
#define __PYX_HAVE__get_nodes_table
#define __PYX_HAVE_API__get_nodes_table
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
/* Module declarations from 'get_nodes_table' */
...
#define __Pyx_MODULE_NAME "get_nodes_table"
int __pyx_module_is_main_get_nodes_table = 0;

/* Implementation of 'get_nodes_table' */
...
static const char __pyx_k_node_num[] = "node_num";
static const char __pyx_k_prob_sum[] = "prob_sum";
static const char __pyx_k_TypeError[] = "TypeError";
static const char __pyx_k_enumerate[] = "enumerate";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_nodes_prob[] = "nodes_prob";
...
static const char __pyx_k_get_nodes_table[] = "get_nodes_table";
...
static const char __pyx_k_Z_Users_linjf_NRL_code_graph_src[] = "Z:\\Users\\linjf\\NRL\\code\\graph\\src\\get_nodes_table.pyx";
...
static PyObject *__pyx_kp_s_Z_Users_linjf_NRL_code_graph_src;
...
static PyObject *__pyx_n_s_get_nodes_table;
...
static PyObject *__pyx_n_s_node_num;
static PyObject *__pyx_n_s_nodes_prob;
...
static PyObject *__pyx_pf_15get_nodes_table_get_nodes_table(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nodes_prob, long __pyx_v_table_size); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_15get_nodes_table_1get_nodes_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_15get_nodes_table_1get_nodes_table = {"get_nodes_table", (PyCFunction)__pyx_pw_15get_nodes_table_1get_nodes_table, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_15get_nodes_table_1get_nodes_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_nodes_prob = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_table_size;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_nodes_table (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nodes_prob,&__pyx_n_s_table_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nodes_prob)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_table_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_nodes_table", 1, 2, 2, 1); __PYX_ERR(0, 2, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_nodes_table") < 0)) __PYX_ERR(0, 2, __pyx_L3_error)
      }
    ...
    __pyx_v_nodes_prob = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_nodes_prob.memview)) __PYX_ERR(0, 2, __pyx_L3_error)
    __pyx_v_table_size = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_table_size == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_nodes_table", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("get_nodes_table.get_nodes_table", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15get_nodes_table_get_nodes_table(__pyx_self, __pyx_v_nodes_prob, __pyx_v_table_size);
...
static PyObject *__pyx_pf_15get_nodes_table_get_nodes_table(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nodes_prob, long __pyx_v_table_size) {
  double __pyx_v_prob_sum;
  long __pyx_v_node_num;
  long __pyx_v_i;
  PyObject *__pyx_v_table = NULL;
  long __pyx_v_node_id;
  ...
  __Pyx_RefNannySetupContext("get_nodes_table", 0);

  /* "get_nodes_table.pyx":4
 * def get_nodes_table(double [:] nodes_prob, long table_size):
 *     cdef:
 *         double prob_sum = 0.0             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_node_num = (__pyx_v_nodes_prob.shape[0]);

  /* "get_nodes_table.pyx":6
 *         double prob_sum = 0.0
 *         long node_num = nodes_prob.shape[0]
 *         long i = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyList_New(1 * ((__pyx_v_table_size<0) ? 0:__pyx_v_table_size)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  { Py_ssize_t __pyx_temp;
    for (__pyx_temp=0; __pyx_temp < __pyx_v_table_size; __pyx_temp++) {
 ...
 *             table[i] = node_id
 */
  __pyx_t_2 = __pyx_v_node_num;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_node_id = __pyx_t_3;

    /* "get_nodes_table.pyx":10
 *     table = [0] * table_size
 *     for node_id in range(node_num):
 *         while (i + 1.0) / table_size < prob_sum + nodes_prob[node_id] and i < table_size:             # <<<<<<<<<<<<<<
 *             table[i] = node_id
 ...
 */
    while (1) {
      ...
      __pyx_t_7 = -1;
      if (__pyx_t_6 < 0) {
        __pyx_t_6 += __pyx_v_nodes_prob.shape[0];
        if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_6 >= __pyx_v_nodes_prob.shape[0])) __pyx_t_7 = 0;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 10, __pyx_L1_error)
      }
      __pyx_t_8 = (((__pyx_t_5 / __pyx_v_table_size) < (__pyx_v_prob_sum + (*((double *) ( /* dim=0 */ (__pyx_v_nodes_prob.data + __pyx_t_6 * __pyx_v_nodes_prob.strides[0]) ))))) != 0);
      if (__pyx_t_8) {
      } else {
        __pyx_t_4 = __pyx_t_8;
        goto __pyx_L7_bool_binop_done;
      }
      __pyx_t_8 = ((__pyx_v_i < __pyx_v_table_size) != 0);
      __pyx_t_4 = __pyx_t_8;
      __pyx_L7_bool_binop_done:;
      if (!__pyx_t_4) break;

      /* "get_nodes_table.pyx":11
 *     for node_id in range(node_num):
 *         while (i + 1.0) / table_size < prob_sum + nodes_prob[node_id] and i < table_size:
 *             table[i] = node_id             # <<<<<<<<<<<<<<
 *             i += 1
 ...
 */
      __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_v_node_id); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (unlikely(__Pyx_SetItemInt(__pyx_v_table, __pyx_v_i, __pyx_t_1, long, 1, __Pyx_PyInt_From_long, 1, 1, 1) < 0)) __PYX_ERR(0, 11, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

      /* "get_nodes_table.pyx":12
 *         while (i + 1.0) / table_size < prob_sum + nodes_prob[node_id] and i < table_size:
 *             table[i] = node_id
 *             i += 1             # <<<<<<<<<<<<<<
 *         prob_sum = prob_sum + nodes_prob[node_id]
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_nodes_prob.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_nodes_prob.shape[0])) __pyx_t_7 = 0;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 13, __pyx_L1_error)
    }
    __pyx_v_prob_sum = (__pyx_v_prob_sum + (*((double *) ( /* dim=0 */ (__pyx_v_nodes_prob.data + __pyx_t_9 * __pyx_v_nodes_prob.strides[0]) ))));
  }

  /* "get_nodes_table.pyx":15
 *         prob_sum = prob_sum + nodes_prob[node_id]
 * 
 *     return table             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_nodes_prob, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "get_nodes_table.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "get_nodes_table._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Z_Users_linjf_NRL_code_graph_src, __pyx_k_Z_Users_linjf_NRL_code_graph_src, sizeof(__pyx_k_Z_Users_linjf_NRL_code_graph_src), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_get_nodes_table, __pyx_k_get_nodes_table, sizeof(__pyx_k_get_nodes_table), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_node_num, __pyx_k_node_num, sizeof(__pyx_k_node_num), 0, 0, 1, 1},
  {&__pyx_n_s_nodes_prob, __pyx_k_nodes_prob, sizeof(__pyx_k_nodes_prob), 0, 0, 1, 1},
 ...
 *         double prob_sum = 0.0
 */
  __pyx_tuple__14 = PyTuple_Pack(7, __pyx_n_s_nodes_prob, __pyx_n_s_table_size, __pyx_n_s_prob_sum, __pyx_n_s_node_num, __pyx_n_s_i, __pyx_n_s_table, __pyx_n_s_node_id); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(2, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Z_Users_linjf_NRL_code_graph_src, __pyx_n_s_get_nodes_table, 2, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 2, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initget_nodes_table(void); /*proto*/
PyMODINIT_FUNC initget_nodes_table(void)
#else
PyMODINIT_FUNC PyInit_get_nodes_table(void); /*proto*/
PyMODINIT_FUNC PyInit_get_nodes_table(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_get_nodes_table(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("get_nodes_table", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_get_nodes_table) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "get_nodes_table")) {
      if (unlikely(PyDict_SetItemString(modules, "get_nodes_table", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         double prob_sum = 0.0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_15get_nodes_table_1get_nodes_table, NULL, __pyx_n_s_get_nodes_table); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_nodes_table, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init get_nodes_table", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init get_nodes_table");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
